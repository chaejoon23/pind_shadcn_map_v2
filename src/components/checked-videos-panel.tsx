  ...
  return (
    <div className="h-full bg-white border-r-4 border-black flex flex-col animate-in slide-in-from-left duration-300 overflow-hidden">
      ...
      <div className="flex items-center justify-between p-2">
        ...
        <Button variant="ghost" size="icon" onClick={onClose} className="h-8 w-8 text-black hover:bg-gray-100">
          <X className="w-4 h-4" />
        </Button>
      </div>
          ...
          <div className="p-4 space-y-4">
            {checkedVideos.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-black text-sm font-medium">No videos selected</p>
                <p className="text-gray-600 text-xs mt-1">Check videos from History to see their locations</p>
              </div>
            ) : (
